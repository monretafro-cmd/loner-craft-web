  ...
  return (
    <div className="fixed right-4 bottom-4 z-40 flex flex-col items-end gap-3 sm:right-6 sm:bottom-6">
      ...
      <a
        ...
        className="flex h-14 items-center gap-2.5 rounded-full bg-[#25D366] px-4 shadow-lift transition-transform duration-300 hover:scale-105"
      >
        ...
        <span className="pr-1 text-sm font-medium text-white">Order on WhatsApp</span>
      </a>
    </div>
  );
}